package cww.alittlegirl.config.datasource;
...
@Configuration
@MapperScan(basePackages = "cww.alittlegirl.multidatasource.localhost", sqlSessionFactoryRef = "localhostSqlSessionFactory")
