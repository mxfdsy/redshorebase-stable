package cww.alittlegirl.config.rabbitmq;


import cww.alittlegirl.constants.BaseCode;
import cww.alittlegirl.constants.BaseException;
import cww.alittlegirl.model.BaseResponseDTO;
import cww.alittlegirl.util.FastJsonUtils;
