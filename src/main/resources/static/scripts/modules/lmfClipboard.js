(function (factory) {
    ...
    layui.define(['jquery', 'layer'], function (exports) {
        ...
        //使用方法  标签增加属性  data-clipboard-text='需要的复制内容' 即可
        //声明委托方法
        layui.$('body').on('click', '[data-clipboard-text]', function () {
            ...
            var clipboard = new Clipboard($self.get(0));
            var layerIndex;
            clipboard.on('success', function (e) {
                if (layerIndex) {
                    layui.layer.close(layerIndex);
                }
                layerIndex = layui.layer.msg('复制成功');

                e.clearSelection();
            });
            clipboard.on('error', function (e) {
                try {
                    layerIndex = layui.layer.msg('复制失败，请重新复制');
                } catch (e) {
        ...
        exports('lmfClipboard', factory(window));
    })
})(function (global) {
